...
{
    public partial class batalTransferGudang : Form,iBatalPost
    {
        iMasterForm _master;
        ...
        public batalTransferGudang(iMasterForm mstr, userDataModel user)
        {
            InitializeComponent();
        ...
        {
            if (_pres.attemptBatalTransferGudang() == true)
            {
                txtAlasan.Clear();
                txtNomor.Clear();
            }
